...
@section('title', 'Recordatorio de cita fiscal')
@section('heading', 'Recordatorio de tu cita fiscal')

@section('intro')
	Hola <strong>{{ $clientName }}</strong>, este es un recordatorio de tu cita fiscal programada para
		...
		<tr>
			<td style="padding: 14px 16px; background-color: #faf6f6; border-left: 3px solid #B0393F;">
				<p style="margin: 0; font-size: 13px; line-height: 1.6; color: #555;">
					Si necesitas reprogramar la cita, contactanos con anticipacion para ayudarte.
				</p>
			</td>
		</tr>
	</table>
