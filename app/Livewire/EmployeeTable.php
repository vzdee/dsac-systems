...
final class EmployeeTable extends PowerGridComponent
{
    ...
    {
        $this->dialog()
            ->question('Eliminar Usuario', '¿Estás seguro de eliminar este empleado? Esta acción no se puede deshacer.')
    ...
    public function deleteEmployee($employee)
    {
        ...
        $this->toast()
            ->success('Eliminación Exitosa', 'Empleado eliminado correctamente')
            ->send();
        // refresh table
